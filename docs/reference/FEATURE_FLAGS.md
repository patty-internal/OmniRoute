...
| `HIDE_UPSTREAM_METADATA`                | boolean | `false`  | Fork flag: redact upstream model/provider identities from client-facing responses (meta headers, SSE diagnostics, combo failures, /v1/models listing) and echo the client-requested model name.                                                                |
