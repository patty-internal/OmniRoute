...
export const createComboSchema = z
  .object({
    ...
    // Fork: model-less combos allowed (subscription groupings materialize models later).
...
export const updateComboSchema = z
  .object({
    ...
    // Fork: 1MB cap (compression/large-context prompts), nullable like theirs.
    system_message: z.string().max(1000000).optional().nullable(),
